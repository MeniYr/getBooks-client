...
import { addBook } from '../../../shared/redux/features/bookSlice';
  ...
  <div className='d-flex justify-content-md-center container col-md-6'>
    <div >
      ...
      <form onSubmit={handleSubmit(onSub)} >
        ...
        <input {...register("publishing_year", { required: true, minLength: 4, maxLength: 4 })} type="text" className='form-control' />
        ...
        <label>קטגוריה:</label>
        <select {...register("cat_id")} type="select" className='form-control' >
        ...
        <div className='d-flex py-2'>
          ...
          <input {...register("deliver")} type="checkbox" className='ms-2 border' />
        </div>
